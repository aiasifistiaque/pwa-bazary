...
export default function CheckoutScreen() {
	...
	const savedAddresses = useSelector((state: RootState) => state.address.addresses);
	...
	const handlePlaceOrder = () => {
		...
		if (!address.name || !address.phone || !address.street || !address.area || !address.city) {
			Alert.alert('Missing Information', 'Please complete your delivery address');
			return;
		}
		if (!selectedPayment) {
							...
							{savedAddresses.map(addr => (
								<Pressable
									...
									style={[
										...
										selectedCheckoutAddr?.id === addr.id && styles.selectedSavedAddress,
									]}
