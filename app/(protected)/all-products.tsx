...
export default function AllProductsScreen() {
	...
	useEffect(() => {
		if (productsData?.doc) {
			...
			setHasMore(productsData.doc.length === 20);
		}
	}, [productsData]);
	...
	return (
		<SafeAreaView style={styles.safeArea}>
			<View style={styles.container}>
				{/* Header */}
				<CustomHeader>
					All Products {productsData?.totalDocs ? `(${productsData.totalDocs} Items)` : ''}
				</CustomHeader>
									...
									!productsDataLoading && (
										<View style={styles.emptyStateContainer}>
											...
											<TouchableOpacity
												...
												<Text style={styles.viewAllButtonText}>View Categories</Text>
											</TouchableOpacity>
										</View>
									)
								)}
